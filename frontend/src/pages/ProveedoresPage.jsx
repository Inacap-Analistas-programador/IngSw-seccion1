        ...
        <div className="container mx-auto px-4 py-6">
            <div className="container mx-auto px-4 py-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Lista de Proveedores ({proveedores.length})</h1>
                  <p className="text-muted-foreground mt-1">Ver y administrar proveedores registrados</p>
                </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex space-x-2">
                            <Button variant="ghost" size="sm" onClick={() => navigate(`/proveedores/editar/${proveedor.id}`)} title="Editar">
