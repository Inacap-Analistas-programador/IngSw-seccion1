...
const cases = [
  { id: 'registrar-pago', title: 'Registrar Pago', desc: 'Crear un pago asociado a una persona y curso (placeholder)', path: '/dashboard/gestion-pagos' },
  { id: 'emitir-comprobante', title: 'Emitir Comprobante', desc: 'Generar comprobante y asociarlo a pagos (placeholder)', path: '/dashboard/gestion-pagos' },
  { id: 'anular-pago', title: 'Anular / Revertir Pago', desc: 'Marcar pago como anulado y registrar trazabilidad (placeholder)', path: '/dashboard/gestion-pagos' },
  { id: 'registrar-prepago', title: 'Registrar Prepago', desc: 'Registrar pagos parciales o reservas (placeholder)', path: '/dashboard/preinscripcion' },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Lista de casos de uso implementados como placeholders en el frontend.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {cases.map((c) => (
          <div key={c.id} className="p-4 rounded-lg bg-card shadow-sm">
            ...
            <div className="mt-3">
              <Button onClick={() => go(c)} className="bg-primary text-primary-foreground">Abrir placeholder</Button>
            </div>
          </div>
        ))}
      </div>
