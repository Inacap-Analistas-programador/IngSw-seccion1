...
// Selected ids para selects controlados
...
onMounted(async () => {
  ...
  // Hardcodear tipoOptions hasta que esté disponible en catalogoStore
  tipoOptions.value = [
    { value: '', label: 'Seleccione un tipo' },
    { value: 1, label: 'Curso Regular' },
    { value: 2, label: 'Taller' },
    { value: 3, label: 'Seminario' },
    { value: 4, label: 'Conferencia' },
  ];
  ...
  // Hardcodear comunas hasta que esté disponible en catalogoStore
  comunaOptions.value = [
