...
import { Search, Plus, Edit, Trash2, ChevronLeft, Database, Eye, Ban, CheckCircle } from 'lucide-react';
...
const MaestrosList = ({ maestroType, title, fields, idField = 'id', statusField = 'vigente' }) => {
  ...
  const handleToggleStatus = async (item) => {
    ...
    try {
      ...
      await maestrosService.update(maestroType, item[idField], updatedItem);
      setItems((prev) =>
