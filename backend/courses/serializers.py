...
class CursoSerializer(serializers.ModelSerializer):
    ...
    # IDs para escritura
    persona_responsable_id = serializers.IntegerField(write_only=True, required=False, source='persona_responsable')
    cargo_responsable_id = serializers.IntegerField(write_only=True, required=False, source='cargo_responsable')
    comuna_lugar_id = serializers.IntegerField(write_only=True, required=False, source='comuna_lugar', allow_null=True)
    tipo_curso_id = serializers.IntegerField(write_only=True, required=False, source='tipo_curso')
    usuario_id = serializers.IntegerField(write_only=True, required=False, source='usuario')
