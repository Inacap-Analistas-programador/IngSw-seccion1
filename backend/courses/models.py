...
class Curso(models.Model):
    id = models.DecimalField(
        db_column="cur_id", max_digits=10, decimal_places=0, primary_key=True
    )
    ...
    cargo_responsable = models.ForeignKey(
        Cargo, on_delete=models.RESTRICT, db_column="car_id_responsable"
    )
    comuna_lugar = models.ForeignKey(
        Comuna,
        on_delete=models.RESTRICT,
    ...
    descripcion = models.CharField(
        db_column="cur_descripcion", max_length=50, blank=True, default=""
    )
    observacion = models.CharField(
        db_column="cur_observacion", max_length=255, blank=True, default=""
    )
    administra = models.IntegerField(db_column="cur_administra")
    cuota_con_almuerzo = models.DecimalField(
        db_column="cur_cuota_con_almuerzo", max_digits=21, decimal_places=6
    )
    cuota_sin_almuerzo = models.DecimalField(
        db_column="cur_cuota_sin_almuerzo", max_digits=21, decimal_places=6
    )
    modalidad = models.IntegerField(db_column="cur_modalidad")
    tipo_curso_enum = models.IntegerField(db_column="cur_tipo_curso")
    lugar = models.CharField(
        db_column="cur_lugar", max_length=100, blank=True, default=""
    )
...
class CursoSeccion(models.Model):
    id = models.DecimalField(
        db_column="cus_id", max_digits=10, decimal_places=0, primary_key=True
    )
    curso = models.ForeignKey(
        Curso, on_delete=models.RESTRICT, db_column="cur_id", related_name="secciones"
    )
    rama = models.ForeignKey(
        Rama, on_delete=models.RESTRICT, db_column="ram_id", null=True, blank=True
    )
...
class CursoCoordinador(models.Model):
    id = models.DecimalField(
        db_column="cuc_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class CursoCuota(models.Model):
    id = models.DecimalField(
        db_column="cuu_id", max_digits=10, decimal_places=0, primary_key=True
    )
    curso = models.ForeignKey(Curso, on_delete=models.RESTRICT, db_column="cur_id")
...
class CursoFecha(models.Model):
    id = models.DecimalField(
        db_column="cuf_id", max_digits=10, decimal_places=0, primary_key=True
    )
    curso = models.ForeignKey(Curso, on_delete=models.RESTRICT, db_column="cur_id")
...
class CursoAlimentacion(models.Model):
    id = models.DecimalField(
        db_column="cua_id", max_digits=10, decimal_places=0, primary_key=True
    )
    curso = models.ForeignKey(Curso, on_delete=models.RESTRICT, db_column="cur_id")
    alimentacion = models.ForeignKey(
        Alimentacion, on_delete=models.RESTRICT, db_column="ali_id"
    )
