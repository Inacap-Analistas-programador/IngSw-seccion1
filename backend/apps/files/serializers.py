...
class FileUploadSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FileUpload
        fields = [
            'id', 'name', 'description', 'file', 'download_url', 'tipo', 'estado',
            'original_name', 'file_size', 'size_human_readable', 'file_extension',
            'mime_type', 'preinscripcion', 'course', 'uploaded_by', 'uploaded_by_name',
            'uploaded_at', 'verified_by', 'verified_by_name', 'verified_at',
            'verification_notes', 'is_public'
        ]
        read_only_fields = [
...
class FileUploadCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FileUpload
        fields = [
            'name', 'description', 'file', 'tipo', 
            'preinscripcion', 'course', 'is_public'
        ]
