    ...
    operations = [
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^\\d{1,5}$", "Código debe ser numérico"
                    )
                ],
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^\\d{1,3}$", "Código debe ser numérico"
                    )
                ],
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^#[0-9A-Fa-f]{6}$", "Color debe ser hex válido"
                    )
                ],
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                validators=[
                    django.core.validators.RegexValidator(
                        "^\\d{1,2}$", "Código debe ser numérico"
                    )
                ],
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Si es una restricción médica/religiosa vs preferencia",
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                blank=True, help_text="Duración típica en horas académicas", null=True
            ),
        ),
        migrations.AlterField(
            model_name="zona",
