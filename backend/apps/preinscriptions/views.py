...
from .serializers import (
    PreinscripcionDetailSerializer, PreinscripcionListSerializer,
    PreinscripcionCreateSerializer, PreinscripcionUpdateEstadoSerializer
)
...
class PreinscripcionViewSet(viewsets.ModelViewSet):
    ...
    queryset = Preinscripcion.objects.select_related('user', 'course').prefetch_related('archivos').all()
    ...
    search_fields = ['user__first_name', 'user__last_name', 'user__username', 'course__title', 'course__code']
