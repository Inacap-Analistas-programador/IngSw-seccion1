...
class Migration(migrations.Migration):
    ...
    operations = [
        # Cuota-related alterations removed to avoid referencing a model
        ...
        migrations.AlterField(
            ...
            field=models.AutoField(
                help_text="Identificador único del comprobante.",
                primary_key=True,
                serialize=False,
            ),
        ),
        migrations.AlterField(
            ...
            field=models.IntegerField(
                help_text="Número correlativo y único del comprobante.", unique=True
            ),
        ),
        migrations.AlterField(
            model_name="comprobantepago",
        ...
        migrations.AlterField(
            ...
            name="COC_ID",
            field=models.AutoField(
                help_text="Identificador único del concepto contable.",
                primary_key=True,
                serialize=False,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                default=django.utils.timezone.now,
                help_text="Fecha y hora en que se realizó el cambio.",
            ),
        ),
        migrations.AlterField(
            model_name="pagocambiopersona",
            name="PCP_ID",
            field=models.AutoField(
                help_text="Identificador único del registro de cambio.",
                primary_key=True,
                serialize=False,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            name="PPA_ID",
            field=models.AutoField(
                help_text="Identificador único del prepago.",
                primary_key=True,
                serialize=False,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            name="PPA_VALOR",
            field=models.DecimalField(
                decimal_places=2, help_text="Monto del saldo a favor.", max_digits=10
            ),
        ),
        migrations.AlterField(
            model_name="prepago",
        ...
        # Historical deletion of Cuota skipped (model removed earlier).
        migrations.DeleteModel(
            name="Pago",
        ),
    ]
