...
class CuotaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cuota
        fields = [
            'id', 'numero', 'monto', 'vencimiento', 'pagada', 
            'pagada_at', 'referencia_pago', 'esta_vencida'
        ]
...
class PagoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pago
        fields = [
            'id', 'preinscripcion', 'preinscripcion_info', 'monto', 'medio', 
            'referencia', 'notas', 'estado', 'fecha_pago', 'fecha_vencimiento',
            'registrado_por', 'registrado_por_name', 'esta_pagado', 'puede_anular',
...
class PagoCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Pago
        fields = [
            'preinscripcion', 'monto', 'medio', 'referencia', 
            'notas', 'fecha_pago', 'fecha_vencimiento'
        ]
