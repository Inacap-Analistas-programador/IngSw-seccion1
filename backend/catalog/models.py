...
class Region(models.Model):
    id = models.DecimalField(
        db_column="reg_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Provincia(models.Model):
    id = models.DecimalField(
        db_column="pro_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Comuna(models.Model):
    id = models.DecimalField(
        db_column="com_id", max_digits=10, decimal_places=0, primary_key=True
    )
    provincia = models.ForeignKey(
        Provincia, on_delete=models.RESTRICT, db_column="pro_id"
    )
...
class Zona(models.Model):
    id = models.DecimalField(
        db_column="zon_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Distrito(models.Model):
    id = models.DecimalField(
        db_column="dis_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Grupo(models.Model):
    id = models.DecimalField(
        db_column="gru_id", max_digits=10, decimal_places=0, primary_key=True
    )
    distrito = models.ForeignKey(
        Distrito, on_delete=models.RESTRICT, db_column="dis_id"
    )
...
class EstadoCivil(models.Model):
    id = models.DecimalField(
        db_column="esc_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Nivel(models.Model):
    id = models.DecimalField(
        db_column="niv_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Rama(models.Model):
    id = models.DecimalField(
        db_column="ram_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Rol(models.Model):
    id = models.DecimalField(
        db_column="rol_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class TipoArchivo(models.Model):
    id = models.DecimalField(
        db_column="tar_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class TipoCurso(models.Model):
    id = models.DecimalField(
        db_column="tcu_id", max_digits=10, decimal_places=0, primary_key=True
    )
    ...
    cant_participante = models.IntegerField(
        db_column="tcu_cant_participante", blank=True, null=True
    )
...
class Cargo(models.Model):
    id = models.DecimalField(
        db_column="car_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Alimentacion(models.Model):
    id = models.DecimalField(
        db_column="ali_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Aplicacion(models.Model):
    id = models.DecimalField(
        db_column="apl_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class Perfil(models.Model):
    id = models.DecimalField(
        db_column="pel_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class PerfilAplicacion(models.Model):
    id = models.DecimalField(
        db_column="pea_id", max_digits=10, decimal_places=0, primary_key=True
    )
    perfil = models.ForeignKey(Perfil, on_delete=models.RESTRICT, db_column="pel_id")
    aplicacion = models.ForeignKey(
        Aplicacion, on_delete=models.RESTRICT, db_column="apl_id"
    )
...
class Proveedor(models.Model):
    id = models.DecimalField(
        db_column="prv_id", max_digits=10, decimal_places=0, primary_key=True
    )
...
class ConceptoContable(models.Model):
    id = models.DecimalField(
        db_column="coc_id", max_digits=10, decimal_places=0, primary_key=True
    )
    descripcion = models.CharField(db_column="coc_descripcion", max_length=50)
    vigente = models.BooleanField(db_column="coc_vigente")
