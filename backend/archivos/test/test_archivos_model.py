...
class Archivo:
    def __init__(self, arc_id=1, tar_id=None, usu_id_crea=None, usu_id_modifica=None, arc_fecha_hora=None, arc_descripcion="Test Desc", arc_ruta="/path/to/file.txt", arc_vigente=True):
        self.arc_id = arc_id
        self.tar_id = tar_id
...
def test_archivopersona_creation():
    ...
    assert str(archivo_persona) == f"Archivo {mock_arc} para Persona {mock_persona} en Curso Sección {mock_curso_seccion}"
