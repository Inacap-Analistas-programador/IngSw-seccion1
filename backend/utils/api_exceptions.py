...
def custom_exception_handler(exc, context):
    ...
    if response is not None:
        ...
        custom_response_data = format_error_response(exc, response.data, response.status_code)
...
def format_error_response(exception, original_data, status_code):
    ...
    return {
        ...
        "details": original_data if isinstance(original_data, dict) else {"detail": original_data},
