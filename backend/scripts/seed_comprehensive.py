#!/usr/bin/env python
"""
Script para inicializar la base de datos con datos completos y bien formateados
GIC - Plataforma de Gestión Integral de Cursos

Este script pobla todas las tablas con datos realistas y bien formateados.
"""
import os
import sys
import django
...
def main():
    ...
    print("\n" + "="*70)
    print("🏕️  SEED COMPREHENSIVE DATABASE - GIC Sistema Scout")
    print("="*70 + "\n")
